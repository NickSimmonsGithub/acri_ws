...
#ifndef GAZEBO_SIMPLETRACKEDVEHICLEPLUGINROS_HH
#define GAZEBO_SIMPLETRACKEDVEHICLEPLUGINROS_HH
...
namespace gazebo {
  ...
  /// defined in TrackedVehiclePluginROS.
  ///
  ...
  class GZ_PLUGIN_VISIBLE SimpleTrackedVehiclePluginROS :
