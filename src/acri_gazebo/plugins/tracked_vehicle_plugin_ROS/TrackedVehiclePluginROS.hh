 ...
 *
*/
#ifndef GAZEBO_PLUGINS_TRACKEDVEHICLEPLUGINROS_HH_
#define GAZEBO_PLUGINS_TRACKEDVEHICLEPLUGINROS_HH_
...
namespace gazebo
{
  ...
  class GZ_PLUGIN_VISIBLE TrackedVehiclePluginROS : public ModelPlugin
  {
    ...
    protected: void OnRosMsgTrackVel(const acri_gazebo::track_velocity& trackVelocity);
    
    void TrackQueueThread();
